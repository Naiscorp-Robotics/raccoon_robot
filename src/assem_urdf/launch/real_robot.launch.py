...
def generate_launch_description():
        ...
        parameters=[
            {
                ...
                "use_sim_time": use_sim_time,
                "lazy": False,  # Don't wait for subscriber before starting
                "queue_size": 1  # Minimize queue size for better responsiveness
            }
        ],
        output="screen",
        arguments=['--ros-args', '--log-level', 'warn']  # Reduce logging for better performance
    )
    ...
    ld = LaunchDescription([
        ...
        declare_sllidar_params_file,  # Added SLLIDAR params file
        # Nodes
