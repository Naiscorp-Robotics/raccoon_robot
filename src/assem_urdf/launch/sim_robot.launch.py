...
def generate_launch_description():
    ...
    # URDF Configuration with use_sim=true for simulation
    ...
    # Note: In simulation mode, we don't need the SLLIDAR node
    # because the simulation provides the scan topic
